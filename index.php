<?php 
    include_once "Expense-Manager/init.php";
    
    // User login check
    if (isset($_SESSION['UserId'])) {
      header('Location: Expense-Manager/templates/3-Dashboard.php');
    }
...
<head>
    ...
    <link rel="icon" href="Expense-Manager/static/images/wallet.png" sizes="16x16" type="image/png">
    <link rel="stylesheet" href="Expense-Manager/static/css/index.css">
    ...
    <div class="container">
        ...
        <form action="index.php" method="post" onsubmit = "return validate()" id="form1">
            ...
            <div class="new-account">
                ...
                <a href="Expense-Manager/templates/2-sign-up.php" style="text-decoration: none;"><span style="color: rgba(5, 0, 255, 0.81); font-weight: bolder; font-family: 'Source Sans Pro';">Sign up</span></a>
            </div>

        </form>

        <div class="img-container">
            <img src="Expense-Manager/static/images/login.jpg" alt="Login-screen-picture">
        </div>
    </div>

<script src="Expense-Manager/static/js/index.js"></script>
</body>
