<?php 
    ...
    if(isset($_POST['register']))
    {
        ...
        else
        {
            ...
            if (!file_exists('../static/profileImages')) {
                mkdir('../static/profileImages', 0777, true);
            }
...
<body>
    <div class="container">
        ...
        <div class="img-container">
            <h1>Create Your Account!</h1>
            <img src="../static/images/registration.jpg" alt="Registration">    
        </div>
        ...
        <form action="2-sign-up.php" method="post" id="form" onsubmit="return validate()" enctype="multipart/form-data">
            ...
            <div class="image-preview" id="imagePreview">
                ...
                <span class="image-preview__default-text">
                    <img src="../static/images/userlogo.png" alt="Default Profile">
                </span>
            </div>
            <label for="imageUpload" class="user-pic-btn">Add Photo</label>
            ...
            <button type="submit" name="register">Let's Go!</button>
            
            <?php  
                if (isset($signupError)) {
                    echo '<div class="error-message">'.$signupError.'</div>';
                }
            ?>
        </form>
    </div>
